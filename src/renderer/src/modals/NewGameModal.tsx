...
import NewSteamGameModal from "@renderer/modals/NewSteamGameModal";
...
export default function NewGameModal({
	...
	const [openSteamModal, setOpenSteamModal] = useState(false);
			...
			>
				...
				<div className="flex flex-col items-center justify-center max-h-[50vh] min-h-10 pt-5 pb-5 overflow-y-auto">
					...
					<GameHorizontalCard
						name="Steam"
						logo={SteamLogo}
						onClick={() => setOpenSteamModal(true)}
					/>
				</div>
			</div>
